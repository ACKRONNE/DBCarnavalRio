...
VALUES(300,'Milton','Rodrigues','m','1980-04-19',82746351,'Da Silva',1),
      (301,'Viviane','Araujo','f','1975-03-25',93685724,NULL,5),
      (302,'Bruno','Bruna','f','1980-07-23',54218936,NULL,9),
      (303,'Sabrina','Sato','f','1981-02-04',73824695,NULL,4),
      (304,'Alexandre','Louzada','m','1957-12-15',61938475,'Oliveira',1),
      (305,'Paulo','Barros','m','1962-05-14',42791583,NULL,2),
      (306,'Mauro','Quintaes','m','1958-08-12',98537162,NULL,3),
      (307,'Rosa','Magalhaes','f','1947-01-08',61354987,NULL,4),
      (308,'Renato','Lage','m','1949-05-21',75931648,'Souza',5),
      (309,'Max ','Lopes','m','1949-05-15',28419673,NULL,6),
      (310,'Cid','Carvalho','m','1967-03-19',94673128,NULL,7),
      (311,'Paulo','Menezes','m','1971-09-19',58346729,NULL,8),
      (312,'Fabio ','Ricardo','m','1975-09-01',72189436,NULL,9),
      (313,'Cahe ','Rodrigues','m','1976-06-30',36549821,NULL,10),
      (314,'Roberto','Szaniecki','m','1961-10-30',47891632,NULL,11),
      (315,'Alex','De Souza','m','1965-09-30',63921857,'Rodriguez',12),
      (316,'Jack ','Vasconcelos','m','1977-05-13',89214357,NULL,14),
      (317,'Marcus','Ferreira','m','1984-07-28',51693872,NULL,15),
      (318,'Jaime ','Cezario','m','1963-10-25',73682915,NULL,16),
      (319,'Carlinhos ','Muvucs','m','1983-09-28',28496137,NULL,17),
      (320,'Alexandre','Colla','m','1958-07-17',93742861,NULL,18),
      (321,'Severo','Luzardo','m','1962-06-29',65831429,NULL,19),
      (322,'Cristiano ','Bara','m','1973-02-11',49217658,'Costa',20),
      (323,'Luiz','Bruno','m','1969-03-19',83724619,NULL,21),
      (324,'Amauri','Santos','m','1951-05-15',56198437,NULL,22),
      (325,'Lane','Santana','m','1974-11-15',29478631,NULL,23),
      (326,'Eduardo','Goncalves','m','1969-01-22',87463592,NULL,24),
      (327,'Fabio ','Santos','m','1982-04-19',51983764,NULL,25),
      (328,'Morgana ','Bastos','m','1976-03-25',28795416,NULL,26),
      (329,'Adilson','Pinto','m','1981-07-23',64821973,NULL,28),
      (330,'Augusto ','de Oliveira','m','1982-02-04',92436857,NULL,30),
      (331,'Luiz ','Cavalcante','m','1959-12-15',48531796,NULL,31),
      (332,'Alexandre ','Rangel','m','1964-05-14',63987142,'Santos',32),
      (333,'Fabianno','Santana','m','1959-08-12',29381467,NULL,33),
      (334,'Robson','Goulart','m','1949-01-08',74832619,NULL,34),
      (335,'Eduardo','Minucci','m','1951-05-21',51628473,NULL,35),
      (336,'Claudinho','de Souza','m','1972-05-04',82735914,NULL,1),
      (337,'Selminha','Sorriso','f','1971-05-30',36479125,NULL,1),
      (338,'Fabio ','Junior','f','1973-09-19',54891673,NULL,13),
      (339,'Jessica','Ferreira','m','1961-12-03',81475329,NULL,13),
      (340,'Ze','Roberto','f','1970-04-26',71549283,NULL,24),
      (341,'Livia','Ferreira','m','1985-08-07',36825794,NULL,24);
